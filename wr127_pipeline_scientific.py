...
# constrained to ONLY analyse WR lines,
# as the O-star line (HeI5876) is proven to be unusable in this dataset.
# It also uses a more conservative 20A half-width for EM lines to prevent bad fits.
...
# The HeI5876 line was proven to be unusable
O_ABS_LINES = {}
# ==============================================================================
...
def aggregate_results(results):
    ...
    safe_write(abs_df, ABS_SUM_CSV) # This will now be an empty file
